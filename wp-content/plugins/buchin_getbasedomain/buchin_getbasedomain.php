<?php
/*
Plugin Name: buchin_getBaseDomain
Plugin URI: http://masbuchin.com/
Description: Get base domain given url (Like given http://google.com or http://blogsearch.google.com return google.com)
Version: 0.1 Alpha
...
function buchin_get_base_domain($url)
{
$debug = 0;
$base_domain = '';
